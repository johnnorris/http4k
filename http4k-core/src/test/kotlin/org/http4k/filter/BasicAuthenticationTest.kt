...
class BasicAuthenticationTest {
    @Test
    suspend fun fails_to_authenticate() {
        val handler: HttpHandler = ServerFilters.BasicAuth("my realm", "user", "password").then { _: Request -> Response(Status.OK) }
    ...
    @Test
    suspend fun authenticate_using_client_extension() {
    ...
    @Test
    suspend fun fails_to_authenticate_if_credentials_do_not_match() {
        val handler = ServerFilters.BasicAuth("my realm", "user", "password").then { _: Request -> Response(Status.OK) }
    ...
    @Test
    suspend fun allow_injecting_authorize_function() {
    ...
    @Test
    suspend fun allow_injecting_credential_provider() {
        val handler = ServerFilters.BasicAuth("my realm", "user", "password").then { _: Request -> Response(Status.OK) }
    ...
    @Test
    suspend fun populates_request_context_for_later_retrieval() {
