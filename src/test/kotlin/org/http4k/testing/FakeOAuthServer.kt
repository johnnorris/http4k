...
class FakeOAuthServer(oAuthClientConfig: OAuthProviderConfig, serviceName: String) : HttpHandler {
    ...
    private val login: HttpHandler = HttpHandler { templates.renderToResponse(OAuthLogin(serviceName, redirectUri(it))) }

    private val submit: HttpHandler = HttpHandler {
     ...
     */
    private val generateAccessToken = HttpHandler {
        Response(FORBIDDEN)
    }
