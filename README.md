...
```groovy
dependencies {
    compile group: "org.http4k", name: "http4k-core", version: "3.97.0"
    compile group: "org.http4k", name: "http4k-server-jetty", version: "3.97.0"
    compile group: "org.http4k", name: "http4k-client-okhttp", version: "3.97.0"
}
```
...
//    content-length: 9
//    date: Thu, 08 Jun 3.97.03:01:13 GMT
//    expires: 0
//    server: Jetty(9.3.16.v3.97.020)
//
//    hello Bob
}
```
